<contextstream>
<!-- contextstream-rules-hash: 8e0edd64f9684721 -->
# Workspace: StreamBox
# Project: lucky5-v8
...
- ContextStream search results contain **real file paths, line numbers, and code content** — they ARE code results
- **NEVER** dismiss ContextStream results as "non-code" — use the returned file paths to `read_file` the relevant code
- Only fall back to local/shell tools for known-new/edited files after ContextStream search misses, or when no usable index exists after the initial grace window
